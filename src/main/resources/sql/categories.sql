...
(anio, apellido, dia, dni, email, identificacion, mes, nombre, password, rol, telefono)VALUES
(1999,'Núñez',20, 39272340,'admin@admin.com',0,'Diciembre','Tomas','admin123', 1,NULL),
(1995,'Morales',28, 39272340,'punto@punto.com',0,'Agosto','Nicolas','punto123', 3,NULL),
(1990,'Barrio Nuevo',17, 39272340,'generico@generico.com',0,'Abril','David','generico123', 2,NULL);
