...
INSERT INTO categoria(background_color, color, icon, nombre, short_desc)
VALUES ('rgba(43,155,14,0.35)', '#0d380d', 'fa-recycle', 'Plásticos',
        'Los plásticos abarcan una gran familia de materiales que se pueden clasificar en varios tipos y reciclar de distintas manera'),
       ('rgba(239,112,0,0.35)', '#EF7000', 'fa-box', 'Cartón',
        'El reciclaje de cartón sigue un proceso muy similar al reciclaje de papel, por lo que se puede obtener separando correctamente este material, y depositándolo en los contenedores de color azul.'),
       ('rgba(231,16,94,0.35)', '#E7105E', 'fa-wine-bottle', 'Eco Botellas',
        'es un envase plástico relleno de más plásticos limpios y secos, residuos que pueden ir desde envoltorios de alimentos hasta cualquier tipo de plástico'),
       ('rgba(5,151,211,0.35)', '#0597D3', 'fa-wine-glass', 'Vidrio',
       ...
       ('rgba(247,214,3,0.80)', '#2A2A2A', 'fa-coins', 'Tapitas',
        'Pieza de plástico que se encuentra en la parte superior de un objeto y que sirve para cerrarlo o cubrirlo'),


       ('rgba(247,214,3,0.80)', '#2A2A2A', 'fa-coins', 'Textil',
        'El reciclaje textil es el método de reutilización o reprocesamiento de ropa usada, material fibroso y restos de ropa del proceso de fabricación.'),
       ('rgba(247,214,3,0.80)', '#2A2A2A', 'fa-coins', 'Pilas y Baterías',
        'El reciclaje de pilas y baterías es una actividad cuyo objetivo es reducir el número de pilas y baterías que son descartadas como residuo sólido urbano.'),
       ('rgba(247,214,3,0.80)', '#2A2A2A', 'fa-coins', 'Metal',
        'Al reciclar la chatarra se reduce la contaminación del agua, aire y los desechos de la minería en un 70%.'),
       ('rgba(247,214,3,0.80)', '#2A2A2A', 'fa-coins', 'Electrónico',
       ...
       ('rgba(247,214,3,0.80)', '#2A2A2A', 'fa-coins', 'Agua',
        'La Reutilización Del Agua. Agua reciclada o de re uso es el proceso de convertir un flujo de residuos en el agua que se puede reutilizar para otros fines.'),
       ('rgba(247,214,3,0.80)', '#2A2A2A', 'fa-coins', 'Neumáticos',
        'Los neumáticos reciclados se convierten en muchos productos útiles. Un producto común de los neumáticos reciclados es el combustible derivado del neumático.'),
       ('rgba(247,214,3,0.80)', '#2A2A2A', 'fa-coins', 'Basura Orgánica',
        'El Reciclaje orgánico o de materia orgánica, es aquel en el que la materia a reciclar, proviende de desechos naturales como son los alimentos, hojas, seres vivos o excrementos.');

INSERT INTO recycloud.usuario
(anio, apellido, dia, dni, email, identificacion, mes, nombre, nombre_imagen, password, rol, telefono)
VALUES (1999, 'Núñez', 20, 39272340, 'admin@admin.com', 0, 'Diciembre', 'Tomas', NULL, 'admin123', 1, NULL),
       ...
       (1989, 'De Pietro', 30, 34870524, 'maximiliano.depietro@gmail.com', 0, 'Octubre', 'Maximiliano', , NULL,
        'maxi123', 3, NULL);

INSERT INTO recycloud.categoria_entrenada(imagen, categoria_id)
VALUES ('VasoDePlastico', 1),
       ('CajaDeCelular', 2),
       ('EcoBotella', 3),
       ('VasoDeVidrio', 4),
       ('TapaDePlastico', 5);

INSERT INTO categoria_informacion(como, descripcion, donde, tipos, categoria_id)
VALUES ('Alguna de las propiedades de los materiales plásticos que pueden hacer variar su precio son las siguientes:',
       ...
       ('3. Presentación:con este término nos referimos a la forma en que se va a vender el plástico recuperado. Normalmente cuanto más pequeños son los trozos mayor es el precio que adquieren. Los más caros son en forma de granza, después triturados y por último como retales.',
        'vacio', 'vacio',
        '3. PVC (Cloruro de polivinilo). El PVC es utilizado en botellas de champú, envases de aceite de cocina, artículos de servicio para casas de comida rápida, etc. El PVC puede ser reciclado como tubos de drenaje e irrigación. 4. LDPE (Polietileno de baja densidad). El LDPE se encuentra en bolsas de supermercado, de pan, plástico para envolver. El LDPE puede ser reciclado como bolsas de supermercado nuevamente.',
        1),
...
INSERT INTO categoria_informacion(como, descripcion, donde, tipos, categoria_id)
VALUES ('Los productos que se pueden dejar los depósitos son:',
...
INSERT INTO categoria_informacion(como, descripcion, donde, tipos, categoria_id)
VALUES ('Lavar bien y secar la botella. Es importante guardar la tapa para cuando se termine de llenar.',
        'Una ecobotella es un envase plástico relleno de más plásticos limpios y secos, residuos que pueden ir desde envoltorios de alimentos hasta cualquier tipo de plástico',
        'vacio', 'vacio', 3),
       ('Otra recomendación a tener en cuenta es dejar la botella a mano para cuando haya que desechar los envoltorios.',
        'vacio', 'vacio', 'vacio', 3),
       ('Se puede armar un cesto aparte para que sea más práctico.Depositar los residuos en la botella.', 'vacio',
        'vacio', 'vacio', 3),
       ('Se necesita una varilla para compactar el material adentro. Hay que asegurarse de que todo esté limpio y seco.Una vez que el material esté bien compactado y cuando ya no entre nada más, volver a tapar la botella y guardarla para depositarla en alguno de los puntos limpios ubicados en la ciudad.',
        'vacio', 'vacio', 'vacio', 3);

INSERT INTO categoria_informacion(como, descripcion, donde, tipos, categoria_id)
VALUES ('Previo a reciclar el vidrio, ya sea para tirarlo o reutilizarlo, es importante lavarlo.',
        ...
        'vacio',
        'Se pueden reciclar frascos, perfumes, las botellas de bebidas, vinos y licores. No se pueden reciclar parabrisas, espejos, ampolletas, tubos fluorescentes, loza, pírex, cristales, vidrio templado y ventanas',
        4),
       ('Te recomendamos usar Cif Active Gel Limón Verde, con ultra poder desengrasante que hace que el lavado sea más fácil y rápido. Quitá todas las etiquetas o stickers del recipiente. Poné el recipiente en tu tacho de reciclaje o llévalo a un centro de reciclaje.',
        'vacio', 'vacio', 'vacio', 4),
       ('Algunos elementos de vidrio, como las lamparitas, tienen otro tipo de reciclaje.Podés reciclar vidrios rotos, pero tenés que tener cuidado.',
        'vacio', 'vacio', 'vacio', 4);

INSERT INTO categoria_informacion(como, descripcion, donde, tipos, categoria_id)
VALUES ('vacio',
        'Una tapa plastica es una parte de un contenedor, como un recipiente o una botella que sirve para cerrar o sellar y evitar que el contenido del recipiente se derrame o se fugue.',
        'vacio',
        'Tapas genéricas para botellas: Estas son de tipo rosca, a las cuales se les denomina cotidianamente taparrosca, o con cincho de seguridad. Son comúnmente utilizadas para el sellado de botellas de plástico que contienen agua, jugos, refresco, aceites, detergentes líquidos, etc.',
        5),
       ('vacio', 'vacio', 'vacio',
        'Tapas flip-top: Son tapas de tipo dosificadoras y están disponibles en distintas medidas. Son utilizadas para los productos líquidos, semilíquidos y productos viscosos de las industrias farmacéutica, bebidas y cosméticos. Tienen aplicaciones para jugos, medicamentos, aderezos, shampos, jabones líquidos, etc.',
        5),
       ('vacio', 'vacio', 'vacio',
        'Tapas disc top: La característica de este tipo de tapas es que al aplicar presión sobre uno de sus lados se levanta por el otro, habilitando una abertura por la que se permite dispersar el producto. Se encuentran disponibles en una gran variedad de modelos y colores para productos tales como, jabones líquidos, salsas, aderezos, medicamentos, etc.',
        5),
       ('vacio', 'vacio', 'vacio',
        'Tapas tipo sport: Este tipo de tapas permite que el líquido pase por un orificio ubicado en su parte central, funcionan a través de presión. Son comúnmente empleadas para sellar contenedores de agua, sueros y bebidas energetizantes.',
        5);

INSERT INTO recycloud.evento
(direccion, fecha, hora_fin, hora_inicio, localidad, titulo, usuario_id)
VALUES ('De los Incas 7546', '2020/06/30', '30:00', '16:00', 'Palermo', 'Clase en vivo de artesanias de reciclaje ', 2),
       ('Arieta 2720', '2020/06/29', '09:30', '20:00', 'Villa Luzuriaga', 'Charla informativa de como reciclar', 3),
       ('Belgrano 1458', '2020/07/01', '11:15', '19:00', 'Ramos Mejía',
        'Reciclaje de EcoBotellas y productos reciclables', 2),
...
INSERT INTO recypoint
    (amount, beneficiary_id, provider_id)
VALUES (1000, 1, 2);